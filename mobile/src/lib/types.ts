// Shared domain types — kept in sync with the web app (web: lib/types.ts).
// Both apps talk to the same Supabase schema, so these definitions must match.
// Re-run `supabase gen types typescript` after schema changes and update both.
